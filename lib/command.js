...
module.exports = class Command {
    ...
    createOptionValues(command) {
        return new Proxy(Object.assign(Object.create(null), command.defaults), {
            set(obj, key, value, reciever) {
                if (!has(command.options, key)) {
    ...
    parse(argv, suggest) {
        ...
        do {
            if (prev) {
                chunk.context.commandPath.push(prev.name);
            }

            prev = chunk.next.command;
